...
function dataCheck(item,temp)
	...
	if (item:getCategory() == "Container") and (temp:getCategory() == "Container") then
		...
		--���������� ���� ����������� - translation: 'Saving container names'
		--�������� �������� � ����� �������� ����� "�������" - translation: Hungry animals get the "hungry" tag next to their name. 
	...
	elseif (item:getCategory() == "Literature") and (temp:getCategory() == "Literature") then
		--������� ����������� �������� - translation: 'Transferring Notebook Contents '
...
function ItemCheck()
    ...
    ContainerHandle(getPlayer():getInventory());--����� NULL - translation: Weighs NULL
